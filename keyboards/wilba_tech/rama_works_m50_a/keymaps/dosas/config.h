...
#define RGB_BACKLIGHT_ALPHAS_MODS_ROW_1 0b1101000000000011
...
#define RGB_BACKLIGHT_CAPS_LOCK_INDICATOR { .color = { .h = 180, .s = 225 }, .index = 255 }
#define RGB_BACKLIGHT_LAYER_1_INDICATOR { .color = { .h = 40, .s = 225 }, .index = 255 }
#define RGB_BACKLIGHT_LAYER_2_INDICATOR { .color = { .h = 20, .s = 225 }, .index = 255 }
#define RGB_BACKLIGHT_LAYER_3_INDICATOR { .color = { .h = 200, .s = 225 }, .index = 255 }
