...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_BASE] = LAYOUT(
		...
		KC_Z, KC_X, KC_C, KC_V, NAV, SYM, NUM, MOUSE),
	...
	[_NAV] = LAYOUT(
		...
		C(KC_Z),C(KC_X),C(KC_C),C(KC_V), xxx, xxx, xxx, xxx),
    ...
    [_MOUSE] = LAYOUT(
		...
		KC_ACL0,KC_ACL1,KC_ACL2, KC_WH_D, KC_NO, KC_NO, KC_NO, KC_NO),
};
