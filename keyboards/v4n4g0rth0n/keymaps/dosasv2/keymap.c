...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_GAME] = LAYOUT(KC_1, KC_2, KC_3, KC_4, KC_5, KC_6,
            ...
            KC_LCTL,  KC_A,  KC_S, KC_D, KC_F, KC_G,      KC_H, SftJ, CtlK,    AltL,   KC_QUOT, LT(_GAME2,KC_ENT),
            KC_LSFT, KC_Z,  KC_X, KC_C, KC_V, KC_B,      KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_ENT,
            KC_TAB, KC_TRNS, KC_LALT,  KC_SPC,      LT(_GAME2,KC_BSPC),         KC_TRNS, KC_TRNS, TG(_GAME)),
  [_GAME2] = LAYOUT(KC_MPRV, KC_MPLY, KC_MNXT, KC_VOLD, KC_MUTE, KC_VOLU,
            ...
            KC_LCTL,  KC_A,  KC_S, KC_D, KC_F, KC_MINS,      KC_H, SftJ, CtlK,    AltL,   KC_SCLN, KC_TRNS,
            KC_LSFT, KC_Z,  KC_X, KC_C, KC_V, KC_PLUS,      KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_TRNS,
            KC_TAB, KC_TRNS, KC_LALT,  KC_0,       KC_BSPC,         KC_TRNS, KC_TRNS, KC_TRNS),
};
