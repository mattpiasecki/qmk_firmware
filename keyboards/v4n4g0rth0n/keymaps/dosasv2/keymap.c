...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_GAME] = LAYOUT(KC_1, KC_2, KC_3, KC_4, KC_5, KC_6,
            KC_ESC,  KC_Q,  KC_W, KC_E, KC_R, KC_T,      KC_Y, KC_U, KC_I,    KC_O,   KC_P, LT(_GAME2,KC_BSPC),
            KC_LCTL,  KC_A,  KC_S, KC_D, KC_F, KC_G,      KC_H, SftJ, CtlK,    AltL,   KC_QUOT, LT(_NAV,KC_ENT),
            KC_LSFT, KC_Z,  KC_X, KC_C, KC_V, KC_B,      KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSPC,
            KC_TAB, KC_LGUI, KC_LALT,  KC_SPC,      LT(_SYM,KC_BSPC),         KC_LEFT, KC_DOWN, KC_RGHT),
  [_GAME2] = LAYOUT(KC_MPRV, KC_MPLY, KC_MNXT, KC_VOLD, KC_MUTE, KC_VOLU,
            KC_GRV,  KC_Q,  KC_7, KC_8, KC_9, KC_ASTR,      KC_Y, KC_UNDS, KC_EXLM,    KC_O,   KC_P, KC_LGUI,
            KC_CAPS,  KC_AT, KC_4, KC_5, KC_6, KC_MINS,      KC_H, SftJ, CtlK,    AltL,   KC_SCLN, KC_TRNS,
            KC_LCTL, KC_Z,  KC_1, KC_2, KC_3, KC_PLUS,      KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_TRNS,
            RESET, KC_TRNS, KC_LALT,  KC_0,       KC_BSPC,         KC_TRNS, KC_TRNS, TG(_DOSA)),
  [_DOSA] = LAYOUT(KC_MPRV, KC_MPLY, KC_MNXT, KC_VOLD, KC_MUTE, KC_VOLU,
            KC_ESC,  KC_Q,  KC_W, KC_E, KC_R, KC_T,      KC_Y, KC_U, KC_I,    KC_O,   KC_P, LT(_NUM,KC_BSPC),
            KC_TAB,  KC_A,  AltS, CtlD, SftF, GuiG,      GuiH, SftJ, CtlK,    AltL,   KC_QUOT, LT(_NUM,KC_ENT),
  ...
  [_NUM] = LAYOUT(KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6,
            ...
            RESET, KC_TRNS, KC_PDOT,      KC_P0,                        KC_F10,       KC_F11,  KC_F12, TG(_DOSA)),
};
