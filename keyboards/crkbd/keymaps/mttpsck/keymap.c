...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_LGUI,MO(_NAV), KC_SPC,    KC_LTNS, MO(_SYM),LT(_MOUS,KC_ENT)
                                      //`--------------------------'  `--------------------------'
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_LGUI,MO(_NAV), KC_SPC,    _______, MO(_SYM),LT(_MOUS,KC_ENT)
                                      //`--------------------------'  `--------------------------'
...
const uint16_t PROGMEM combo_mply[] = {KC_COMM, KC_SLSH, COMBO_END};
const uint16_t PROGMEM combo_mprv[] = {KC_COMM, KC_DOT, COMBO_END};
const uint16_t PROGMEM combo_mnxt[] = {KC_DOT, KC_SLSH, COMBO_END};
const uint16_t PROGMEM combo_mute[] = {KC_P, KC_SLSH, COMBO_END};
const uint16_t PROGMEM combo_volu[] = {KC_P, KC_QUOT, COMBO_END};
const uint16_t PROGMEM combo_vold[] = {KC_QUOT, KC_SLSH, COMBO_END};
...
combo_t key_combos[COMBO_COUNT] = {
  ...
  [COMBO_MPLY] = COMBO(combo_mply,KC_MPLY),
  [COMBO_MPRV] = COMBO(combo_mprv,KC_MPRV),
  [COMBO_MNXT] = COMBO(combo_mnxt,KC_MNXT),
  [COMBO_MUTE] = COMBO(combo_mute,KC_MUTE),
  [COMBO_VOLU] = COMBO(combo_volu,KC_VOLU),
  [COMBO_VOLD] = COMBO(combo_vold,KC_VOLD),
};
#endif
