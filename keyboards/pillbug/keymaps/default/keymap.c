...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        KC_A, KC_S, KC_D, KC_F, KC_G,            KC_GRV,         KC_H, KC_J, KC_K, KC_L, KC_SCLN,
        LSFT_T(KC_Z), KC_X, KC_C, KC_V, KC_B,    KC_CAPS,         KC_N, KC_M, KC_COMM, KC_DOT, RSFT_T(KC_SLSH),
    ...
    [_NUM] = LAYOUT(
        ...
        KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_HOME,   xxx,         KC_END, KC_PIPE, KC_BSLS, KC_DQUO, KC_QUOT,
